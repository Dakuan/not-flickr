...
describe('Flux', function () {
  ...
  describe('#dispatchAsync()', function () {
    ...
    it('adds unique dispatch id to keep track of async actions', function callee$2$1() {
      var flux, dispatch, actionId;
    ...
    it('emits dispatch event', function callee$2$2() {
    ...
    it('dispatches with error if promise rejects', function callee$2$3() {
